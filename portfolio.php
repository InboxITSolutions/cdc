...
<div class="cd-intro-block about-main">
        <div class="content-wrapper">
           <h3 align="center" class="animate-about-h3"><span class="index_topic">OUR PORTFOLIO</span></h3>
        <br/>
        <h1 align="center"><span class="index_caption" style="font-size: 30px;">Pleasure in the job puts perfection in work</span> </h1>
          <p class="animate-about-p">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
          ...
          proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
            ...
            <a href="#0" class='cd-btn btn-default' data-action="show-projects">See All Projects</a>
        </div>
    </div> <!-- .cd-intro-block -->

    <div class="cd-projects-wrapper">
        <ul class="cd-slider" style="list-style:none;">
            <li class="current">
                <a href="#0" data-toggle="tooltip" data-placement="left" title="CLICK">
                   <img src="assets/advertise1.jpg" alt="project image">
            ...
            <li>
                <a href="#0">
                <img src="assets/advertise2.jpg" alt="project image">
                    <div class="project-info">
                        <h2>Project 2</h2>
            ...
            <li>
                <a href="#0">
                    <img src="assets/advertise3.jpg" alt="project image">
                    <div class="project-info">
                        <h2>Project 3</h2>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </div>
            ...
            <li>
                <a href="#0">
                    <img src="assets/advertise4.jpg" alt="project image">
                    <div class="project-info">
                        <h2>Project 4</h2>
            ...
            <li>
                <a href="#0">
                  <img src="assets/advertise5.jpg" alt="project image">
                    <div class="project-info">
                        <h2>Project 5</h2>
